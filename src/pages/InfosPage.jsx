    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-8 border-l-4 border-[#D4AF37]">
        ...
        <ul className="list-disc list-inside text-gray-600 space-y-1 ml-4">
          ...
          <li>Frais de dossier : <strong className="text-[#D4AF37]">3000 FCFA</strong> (non remboursables)</li>
        </ul>
        ...
        <p className="text-gray-600">Du <strong>19 mai</strong> au <strong>10 juillet 2025</strong></p>
      </div>

      {/* Épreuves par niveau */}
      <div className="bg-white rounded-lg shadow-lg p-6 mb-8 border-l-4 border-[#1A3A6B]">
        <h2 className="text-2xl font-heading font-bold text-[#0F1A2C] mb-4">✏️ Épreuves par niveau</h2>
